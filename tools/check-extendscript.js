/*
 * LazyKick — ExtendScript syntax check (no Node required).
 *
 ...
 * trailing commas in object and array literals. Same check as LazyLord's.
 */
...
WScript.Echo("LazyKick - ExtendScript syntax check");
WScript.Echo("");
